...
const Contact = () => {
  ...
  return (
    <div
      className="w-full min-h-screen bg-[#0f0d15] flex flex-col items-center"
      style={{
    ...
    >
      ...
      <div className="flex-grow flex items-center justify-center w-full">
        <div className="font-custom1 max-w-5xl w-full px-6 md:px-0 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-16 pt-20">
          {/* Left Text */}
